...
For detailed information on the components and how to build the overall scheduler please see the [yunikorn-core](https://github.com/G-Research/yunikorn-core).
...
### Go based components
The dependent projects can use the interface by importing _github.com/G-Research/yunikorn-scheduler-interface/lib/go/si_ as part of the code:
```go
package example

import "github.com/G-Research/yunikorn-scheduler-interface/lib/go/si"
import "github.com/G-Research/yunikorn-scheduler-interface/lib/go/common"
```
